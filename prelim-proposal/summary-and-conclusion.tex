...
In section \ref{subsec:modeling-time}, we propose to expand on existing
literature on modeling real time systems in rewriting logic to enhance
the semantics of time in \MediK{}, with the goal of supporting timed
analysis in \MediK{}.
