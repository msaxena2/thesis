...
The configuration for Imp (lines 24-26) consists of a \emph{top} cell
...
sort \inlinek{Pgm} defined on line 18. The dot (\inlinek{.}) in \K is used to
indicate \emph{empty}. For instance, \inlinek{.Map} on line 26 defines
