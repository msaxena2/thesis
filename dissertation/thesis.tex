...
\newcommand{\inlinekmath}[1]{\lstinline[mathescape=true,style=inlineksty,language=k,keepspaces]!#1!}
\newcommand{\inlinemedikmath}[1]{\lstinline[mathescape=true,style=inlinemediksty,language=medik]!#1!}
\newcommand{\inlinemedikimp}[1]{\lstinline[mathescape=true,style=inlineimpsty,language=imp]!#1!}
\lstset{ literate={~}{{\raisebox{0.5ex}{\texttildelow}}}{1} }
\lstset{captionpos=b,escapeinside={@}{@},xleftmargin=3ex}
