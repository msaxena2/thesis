...
\newcommand{\inlinemedik}[1]{\lstinline[style=mediksty,language=medik,basicstyle=\ttfamily\small]{#1}}
\newcommand{\inlinek}[1]{\lstinline[style=ksty,language=k,basicstyle=\ttfamily\small]{#1}}
