...
\subsection{Simple Tables}\label{sec:tables}
...
commonly in \BPGs{}. For instance, in the running sepsis example,
...
If the heart rate lies any of the intervals (closed on the left, open on the right) on Lines \ref{lstline:interval-begin}-
\ref{lstline:interval-end}, the
