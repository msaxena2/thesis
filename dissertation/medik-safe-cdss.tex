...
Recall from \autoref{sec:k-based-background} that \BPGs{}
...
expressions over program identifiers (denoted by the builtin $\K{}$ production
...
syntax Exp ::= Id                                                                @\label{lstline:value-start}@
             ...
             > Exp "+" Exp                                 [seqstrict, left]     @\label{lstline:arith-exp-syntax}@
...
\begin{lstlisting}[
  ...
  syntax Stmt ::= StandaloneExp ";"                               [strict]
                ...
                | "return" Exp ";"                                [strict(1)]
                | "var" Id "=" Exp ";"                            [macro]
                > Exp "=" Exp ";"                                 [strict(2)] @\label{lstline:assignment}@
                > "var" Id ";"
                | "vars" Ids ";"                                  [macro-rec]
                | Block
