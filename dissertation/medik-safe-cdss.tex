...
variable assignment (\autoref{lstline:assignment-stmt}), \inlinek{if-else}
(Lines \ref{lstline:if-stmt} and \ref{lstline:if-else-stmt}) and \inlinek{while}
...
\begin{lstlisting}[
  ...
  syntax Stmt ::= StandaloneExp ";"                               [strict]
                ...
                | "broadcast" Id "," "(" Exps ")" ";"             [strict(2)] @\label{lstline:broadcast-stmt-alternative}@
                | "goto" Id ";"                                   [macro]
