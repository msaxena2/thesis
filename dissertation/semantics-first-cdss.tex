...
whose syntax and semantics are inspired by C and Java.

In \autoref{lst:imp-syntax} and \autoref{lst:imp-semantics},
we present the syntax and semantics of Imp respectively.
In $\K{}$, code must exist inside an organizational unit called a
\inlinek{module} that has a name, and can import other \inlinek{modules}.
For example, \inlinek{module IMP-SYNTAX ... endmodule}, on \autoref{lstline:imp-module-start}
to \autoref{lstline:imp-module-end} in \autoref{lst:imp-syntax} defines
