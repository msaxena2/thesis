...
of practitioner provided clinical data. The example
in \figurename{} \ref{fig:sepsis-tool-main} shows
the \UI{} for a \CDSS{} designed for a tablet at the patient's
bedside.

\paragraph{Additional Infrastructure}

For a functioning \CDSS{}, some additional infrastructure is
required to glue all components together.
