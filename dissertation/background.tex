...
Consider for example the \BPG{} for managing sepsis from section
\ref{sec:bpg-background}. As shown in \figurename{} \ref{fig:sepsis-screening},
in order to determine whether a patient is potentially, data and
...
\HCPs{} interact with the system through a \UI{} that
displays alerts, recommendations and facilitates input
of practitioner provided clinical data. As mentioned earlier,
