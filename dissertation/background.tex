...
\begin{figure}[b!]
  \centering
  \includegraphics[width=0.6\textwidth]{sepsis-screening-osf}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.6]{FluidWorkflow-fmcad.pdf}
...
The reasons why healthcare practitioners deviate from guidelines
...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.95\textwidth]{sepsis-tool-main}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.45\textwidth]{sepsis-graphs}
