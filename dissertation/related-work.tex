...
Asbru guidelines are developed and published as part of the Digital Electronic
Guidelines Library (\DEGEL{}) \cite{HatsekBook08}. A guideline in the library
consists of a set of plans and corresponding time annotations. During execution,
...
Endocrinology, Pulmonology, Gynaecology, involving researchers
from Stanford and Ben Gurion University \cite{YoungAMIA05}.
