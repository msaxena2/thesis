...
\begin{itemize}
  \item Has an informal, yet comprehensive semantics.
...
where other languages (such as the Arden Syntax) had been developed and
utilized. Thus, perspectives and learnings from existing efforts guided
the development of \GLIF{}.
