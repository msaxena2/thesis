...
In chapter \ref{chapter:hurdles-cdss-adoption}, we discussed several
...
for the mentioned feature.
  ...
  \begin{table}[th]
   ...
   | >{\centering\arraybackslash}X
    ...
    HELEN                           & $\greencheck$                    & $\greencheck$             & $\redcross$           & $\redcross$ \\
    PRODIGY                         & $\greencheck$                    & $\greencheck$             & $\redcross$           & $\redcross$ \\
...
EON (section \ref{sec:eon}) switched from small, modular and
...
Approaches such as \GLARE{} (section \ref{sec:glare}) and \GPROVE (section
...
defined in section \ref{sec:asbru-verification} utilizes foundational work in
...
For instance, for the \MDA{}-based approach described in section
\ref{sec:mda-verification}, we refer to Statecharts as the \say{\HCP{}-friendly}
