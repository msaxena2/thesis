...
\subsection{The Guideline Interchange Format}
...
through:
\begin{itemize}
  \item Development of a standardized electronic format for rapid
    dissemination.
  \imte Implementation of a repository of commonly-used
\end{itemize}
