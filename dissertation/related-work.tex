...
In Asbru, guidelines are represented using skeletal plans, or a
sequence of generalized steps \cite{ShaharAIM98}.
These steps are instantiated with specific operations in a specific
problem context to solve a given problem \cite{FriedlandJAR85}.
In Asbru, specifically, plans comprise of problem-solving tasks
