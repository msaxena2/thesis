...
support systems. These systems assist healthcare providers (\HCPs{}) follow
...
for various clinical scenarios \cite{FieldClinical90}.


healthcare providers follow evidence-based best practices by providing situation
specific advice for various clinical scenarios.
