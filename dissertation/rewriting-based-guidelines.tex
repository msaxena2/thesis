...
<machines>
  <machine>                                      @\label{lstline:machine-add-begin}@
     <id> $\mathcal{M}$ </id>
     <state> u </state>
     ...
  ...
  ...
<machines>
<inputBuffer> .JSONs </inputBuffer> @\label{lstline:init-inputBuffer}@
<outputBuffer> .JSONs </outputBuffer> @\label{lstline:init-outputBuffer}@
\end{lstlisting}
